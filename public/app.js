...
// Función principal para consultar el reglamento - CON CORS
exports.consultarReglamento = onRequest(async (req, res) => {
    ...
    try {
        ...
        if (!pregunta) {
            res.json({success: false, error: 'Pregunta requerida'});
            return;
        }
...
// Función auxiliar para obtener información específica - CON CORS
